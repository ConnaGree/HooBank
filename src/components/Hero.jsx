  ...
  >
    ...
    >
      ...
      <div className="flex flex-row justify-between align-items w-full">
        <h1 className="flex-1 font-poppins font-semibold text-[60px] md:text-[72px] ss:leading-[100px] leading-[90px] mt-5 text-white">
      ...
      <p
        className={`text-dimWhite flex-1 font-poppins font-normal max-w-[100%] w-[483px] leading-[30px] mt-12 text-[16px] lg:text-[18px] text-white`}
      >
